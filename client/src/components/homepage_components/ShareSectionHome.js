  ...
  return (
    <section className='share-section'>
      ...
      <ul className='social-container'>
        ...
        <li><a href='https://twitter.com/ColbyCollege' target='_blank' rel='noreferrer'><img src={twit} alt='twitter' /></a></li>
        <li><a href='https://www.instagram.com/colbycollege' target='_blank' rel='noreferrer'><img src={insta} alt='instagram' /></a></li>
      </ul>
    </section>
  )
}
